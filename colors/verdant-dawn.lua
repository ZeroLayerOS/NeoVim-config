-- Verdant Dawn — A soft, nature-inspired dark theme for Neovim.
-- Designed around quiet pre-dawn greenery, cool morning skies, and warm accents.

local c = {
  bg = "#1e2624", -- Deep pre-dawn garden base
  bg_dark = "#141a18", -- Under-canopy shadow / darker panels
  bg_light = "#2a332f", -- Dew surface / elevated UI background
  fg = "#e8ddc7", -- Warm cream foreground
  fg_dim = "#8a9490", -- Muted grey-green text
  sage = "#5c6b5f", -- Faded mint green for comments
  sky = "#7ea8c4", -- Morning sky blue for keywords
  leaf = "#8fb996", -- Fresh leaf green for functions
  peach = "#e0a97a", -- Soft peach for strings
  honey = "#d4b483", -- Warm honey for constants & numbers
  lavender = "#a7a0c4", -- Soft lavender for types & data structures
  coral = "#e08a7a", -- Warm coral for special characters, errors, & accents
  moss = "#6f8f6a", -- Forest moss green for diff additions & success status
  dawn = "#e6b566", -- Warm sunrise amber for warnings & cursor line highlights
  mist = "#6f8a8f", -- Blue-grey mist for operators & delimiters
  bloom = "#f3ead9", -- Bright highlight tone for active focus
}
...
vim.g.colors_name = "verdant-dawn"
...
hl(0, "Search", { fg = c.bg_dark, bg = c.dawn })
...
hl(0, "Todo", { fg = c.bg_dark, bg = c.dawn, bold = true })
...
hl(0, "DiffChange", { fg = c.bg_dark, bg = c.dawn })
