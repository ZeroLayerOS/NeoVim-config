return {
  ...
  -- CMake support
  -- FIX: was `event = "VeryLazy"` alongside `keys`, which meant lazy.nvim
  -- loaded it (and everything it pulls in — nvim-dap, mason.nvim's full
  -- registry, etc.) almost immediately on every startup, keys or not.
  -- Now it only loads for CMake/C/C++ filetypes, or on-demand via keys
  -- if you're outside those filetypes for some reason.
  {
